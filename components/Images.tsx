  ...
  return (
    <div>
      <button
        ...
        className="fixed bottom-10 right-10 bg-slate-400 text-white
      px-5 py-3 rounded-md hover:bg-slate-500 focus:outline-none
      focus:ring-2 focus:ring-slate-400 font-bold z-20"
      >
        {!isLoading && isValidating ? 'Refreshing...' : 'Refresh Images'}
      </button>
      {isLoading && (
        <p className="animate-pulse text-center pb-7 font-extralight">
          Loading<span className="text-slate-400"> AI</span> Generated Images
        </p>
      )}
      <div
